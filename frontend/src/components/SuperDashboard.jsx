...
import NewXDashboard from './strategies/NewXDashboard';
  ...
  const renderStrategyDashboard = () => {
    ...
    switch (currentStrategy.name) {
      ...
      case 'MTM V3 Strategy':
        return <MTMv2Dashboard strategy={currentStrategy} />;
      case 'MTM V4 Strategy':
        return <MTMv2Dashboard strategy={currentStrategy} />;
      case 'MTM V5 Strategy':
        return <MTMv2Dashboard strategy={currentStrategy} />;
      case 'MTM V5 Shared Strategy':
        return <MTMv2Dashboard strategy={currentStrategy} />;
      case 'MTM V5 Shared Strategy V2':
        return <MTMv2Dashboard strategy={currentStrategy} />;
      case 'MTM V5 Shared Strategy V3':
        return <MTMv2Dashboard strategy={currentStrategy} />;
      case 'MTM V5 Shared Strategy V3 Anti':
        return <MTMv2Dashboard strategy={currentStrategy} />;
      ...
      case 'Fifty Percent Full Spectrum V4':
        return <FiftyPercentFullSpectrumDashboard strategy={currentStrategy} />;
      case 'Fifty Percent Full Spectrum V4 CE':
        return <FiftyPercentFullSpectrumDashboard strategy={currentStrategy} />;
      case 'Fifty Percent Full Spectrum V4 PE':
        return <FiftyPercentFullSpectrumDashboard strategy={currentStrategy} />;
      case 'New X Strategy':
