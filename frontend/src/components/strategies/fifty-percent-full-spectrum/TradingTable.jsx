...
import { Activity, Clock, CheckCircle, XCircle, AlertTriangle, Target, RotateCcw, TrendingDown, TrendingUp, ChevronDown, ChevronUp, Trash2, ArrowUpCircle, ArrowDownCircle, Download } from 'lucide-react';
...
const TradingTable = ({ strategy, instrumentData, tradingActions, tradeEvents = [], socketEvents = [], currentDropThreshold }) => {
  ...
  const downloadPDF = async () => {
    ...
    import("jspdf").then(({ default: jsPDF }) => {
      ...
      // ---- HEADER ----
      text("Full Spectrum Cycle History", 18, true);
      text(
