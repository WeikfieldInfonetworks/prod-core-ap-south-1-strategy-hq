    ...
    async processDiff10Block(ticks) {  
        if (this.mainToken && this.oppToken) {
            ...
            if(this.instrument_bought) {
                ...
                else if(change <= this.globalDict.realBuyStoploss && !this.rebuyDone && !this.reachedHalfTarget && !this.realBuyStoplossHit) {
                ...
                else if(this.realBuyStoplossHit && this.rebuyDone && !this.reachedHalfTarget && change <= this.globalDict.realBuyStoploss){
                    this.rebuyDone = false;
                    this.realBuyStoplossHit = false;
                    this.reachedHalfTarget = false;
