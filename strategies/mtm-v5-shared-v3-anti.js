...
class MTMV5SharedStrategyV3Anti extends BaseStrategy {
    constructor() {
        super();
    ...
    setUserInfo(userName, userId) {
        ...
        this.strategyUtils.logStrategyInfo(`MTM V5 Strategy Shared V3 Anti initialized for user: ${userName} (ID: ${userId})`);
        this.userId = userId;
    }
    ...
    initialize(globalDict, universalDict, blockDict, accessToken) {
        ...
        console.log('=== MTM V5 Strategy Shared V3 Anti Initialization ===');
    ...
    processNextCycleBlock(ticks) {
        ...
        this.cycleInfo.strategy = this.universalDict.useOppositeStrategy ? "R" : "A";
...
module.exports = MTMV5SharedStrategyV3Anti;